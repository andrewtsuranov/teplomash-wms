...
.pallet-background.pending {
  border: 0.7rem solid #ecaf0e; /* Желтая рамка для PENDING */
}

.pallet-status.finish,
.pallet-background.finish {
  border: 0.7rem solid #19da21; /* Зеленая рамка для COMPLETED */
}

.pallet-status.error,
.pallet-background.error {
  border: 0.7rem solid #e80f0f; /* Красная рамка для CANCELED */
}
